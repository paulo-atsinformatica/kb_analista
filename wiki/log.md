...
- **Observações:**
  ...
  - Windows » Business segue acumulando rotinas confirmadas via as entrevistas de Caixa e Pagar (46 até agora).
  - Movimentos Liquidação com Cheques Pré Recebidos e Movimentos Prorrogação confirmadas como existentes em 3 módulos (Pagar/Receber/Business) e movidas para `wiki/rotinas/_compartilhadas/`. No Receber, os nomes pré-mapeados eram diferentes ("Movimentos Liquidação Com Pré-datados" e "Movimentos Prorrogação Individual") — marcados como a mesma rotina, com nota explicativa. "Movimentos Prorrogação Em Lote" (só existe no Receber) é rotina distinta, ainda não entrevistada.
